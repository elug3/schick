...
- **Features:**
  ...
  - **NANO checkout bridge** (`GET /nano/checkout`) never copies an empty PG body to the shopper — empty/unusable 2xx falls back to the browser launcher; 3xx is forwarded as an absolute Location (see [payment-service.md](payment-service.md))
